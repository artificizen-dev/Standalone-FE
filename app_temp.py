...
API_BASE_URL = "https://kxbnf3vi5j.us-east-1.awsapprunner.com/api"
...
def main():
    ...
    with st.sidebar:
        if st.session_state.session_state.logged_in and st.session_state.session_state.role == "admin":
            ...
            st.divider()
            selected_page = option_menu("Main Menu", ["Upload Documents", "Uploaded Documents", "Chatbot", "Logout"], 
                                    icons=["cloud-upload", "file-earmark-text", "chat-dots", "box-arrow-right"], 
